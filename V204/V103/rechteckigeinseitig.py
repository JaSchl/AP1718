...
plt.title('Rechteckiger Stab, einseitige Einspannung') #Ueberschrift, die ueber dem PLot stehen wird
...
plt.xlabel(r"$(Lx^2-\frac{1}{3}x^3)/10^{-3} \,\, in \,\, m^3$")
...
plt.savefig('plot1.pdf') #erstellt und speichert automatisch den Plot als pdf datei