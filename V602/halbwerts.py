...
t, Z = np.genfromtxt('cuhalb.txt' , unpack=True)
x, y = np.genfromtxt('h1.txt' , unpack=True)
#a, c = np.genfromtxt('h2.txt' , unpack=True)
...
#Achsen beschriften!!!!!!
plt.plot(x, y, 'b--', label=r"y = 1491,25")
