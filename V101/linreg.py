...
x, y = np.genfromtxt('Dateiname.txt' , unpack=True)
...
L1plot = np.linspace(0, 6) #Grenzen fuer linregr. guckt nach den Grenzwerten fuer die x-Werte.
plt.title('Plot Gravitationsmethode') #Ueberschrift, die ueber dem PLot stehen wird
...
plt.savefig('Praeze.pdf') #erstellt und speichert automatisch den Plot als pdf datei